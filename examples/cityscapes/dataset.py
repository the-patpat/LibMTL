# Code is copied from https://github.com/yobibyte/unitary-scalarization-dmtl/blob/main/supervised_experiments/loaders/cityscapes_loader.py
...
class CityScape(Dataset):
    ...
    def __init__(self, root, mode='train', augmentation=False):
        ...
        train_index = np.arange(data_len)[:train_val_split_idx]
        val_index = np.arange(data_len)[train_val_split_idx:]
        # read the data file
        if self.mode == 'train':
